...
{NOTE: accoring to Rampal this has been solved analytically (for the Protracted Birth and Death model). Where?}.
...
data set. \textbf{NOTE: maybe discuss with Rampal to remove confusion. I see if I can get the
students to make a histogram of number of taxa in the incipient species trees, as Rampal
requires a geometric distribution}

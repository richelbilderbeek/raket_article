...
the posterior. Recently, for example, \cite{moller2018} show that the effect
of choosing a tree prior biases the estimation of the molecular clock rate, 
for DNA sequences of 100-1000 base pairs.
 
This bias has its implications in the research and policy regarding rapidly 
evolving viruses. [NOTE: I would say that same study concludes 
that it does not matter for DNA alignments of 15K, which is the DNA 
alignment length that I use].

...
tree, as this requires a very specific scenario.
...
result in an effective sample size (ESS) of the posterior of at least 200 
to have a strong enough inference (\cite{beastbook}). The MCMC sampling interval is 
chosen in such a way that this is the case for all simulations. For simulations
